...
Funcionalidade: Alugar filme
  ...
  Cenario: Deve alugar um filme com sucesso
    ...
    Então o estoque de filmes será de R$ 1 unidade

  Cenario: Não deve alugar filme sem estoque
    Dado um filme com estoque de 0 unidades
    Quando alugar
    Então não será possível por falta de estoque
    E o estoque de filmes será de R$ 0 unidade
  ...
  Esquema do Cenário: Deve dar condições conforme tipo de aluguel
    ...
    Quando alugar
    Então o preço do aluguel será R$ <valoraluguel>
    E a data de entrega será em <qtdeDias> dias
    E a pontuação será de <pontuacao> pontos

    Exemplos: 
      | preco | tipo      | valoraluguel 	| qtdeDias 	| pontuacao |
      |     4 | extendido |     8 				|     3 		|         2 |
      |     4 | comum     |     4 				|     1 		|         1 |
      |			10| extendido |    20					|     3     |         2 |
      |			5	| semanal		|			15				|			7			|					3	|
