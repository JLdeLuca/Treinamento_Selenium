...
public class CT03EnviarMensagem {
	...
	public void testCT03EnviarMensagem() throws Exception {
		...
		Thread.sleep(10000);
		String mensagem = driver.findElement(By.xpath("//div[@id='wpcf7-f372-p24-o1']/form/div[2]")).getText();
		if (mensagem == "Agradecemos a sua mensagem. Responderemos em breve.") {
			...
			assertEquals(driver.findElement(By.xpath("//*[@id=\"wpcf7-f372-p24-o1\"]/form/div[2]")).getText(),"Ocorreu um erro ao tentar enviar sua mensagem. Tente novamente mais tarde.");
